                ...
                <Navbar light fixed="top" expand="md" fixed="top" className = 'navBar' onScroll={this.handleScroll} style={this.state.navstyle} >
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            ...
                            <NavItem className='d-flex justify-content-center'>
                                <NavLink className="nav-link"  to='/hogwarts' style={this.state.navlinkstyle}  onClick={this.closeNavbar}><span className="fa fa-fort-awesome fa-lg"></span>Hogwarts</NavLink>
                            </NavItem>
                            <NavItem className='d-flex justify-content-center'>
